...
import { getProductStat } from "../../../../services/apiServices"
...
const StatSeller = () => {
    ...
    const columns = [
        ...
        { header: 'Số lượng đã bán', key: 'total_sell' },
    ...
    const getData = async () => {
        ...
        setDataStat(res.data.sort((a, b) => b.total_sell - a.total_sell))
    ...
    return (
        <>
            <div className="revenue-content">
                <p>Thống kê các sản phẩm bán chạy</p>
