...
const saveExcel = async (userdata, year) => {
    ...
    const columns = [
        ...
        { header: 'Doanh thu hàng tháng', key: 'month_revenue' },

    ];

    try {

        const fileName = "Bao cao doanh thu theo thang";
        ...
        title.value = "Báo cáo doanh số theo tháng"
        title.alignment = {
            horizontal: "center",
            vertical: "middle"
        }
        ...
        const listdoanhthu = userdata.map(item => item.month_revenue)
